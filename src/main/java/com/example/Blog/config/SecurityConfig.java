...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/blog/update/{postId}")
                    .access("@userSecurity.hasUserId(authentication, #postId)")
                .antMatchers(HttpMethod.GET, "/updateComment/{commentId}")
                    .access("@userSecurity.hasCommentId(authentication, #commentId)")
                .antMatchers(HttpMethod.DELETE, "/deleteComment/{commentId}")
                    .access("@userSecurity.hasCommentId(authentication, #commentId)")
                .and()
                .httpBasic()
                .and()
