...
public interface PostRepository extends JpaRepository<Post, Integer> {
    ...
    @Query("select p from Post as p where p.publishedAt like CONCAT(:publishedAt,'%') or p.author = :filterString or p.id in :ids")
    List<Post> findByFiltering(@Param("publishedAt") String publishedAt,
